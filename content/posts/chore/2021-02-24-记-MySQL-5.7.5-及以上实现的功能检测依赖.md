...
description: "从 ONLY_FULL_GROUP_BY 报错出发，分析 MySQL 5.7.5 之后函数依赖检测与 GROUP BY 行为变化。"
versionNote: "本文聚焦 MySQL 5.7.5 之后的 ONLY_FULL_GROUP_BY 行为；不同大版本和 SQL mode 配置可能产生不同结果。"
tags:
  - MySQL
  - 数据库
---
