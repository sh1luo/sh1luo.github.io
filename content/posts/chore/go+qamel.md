...
description: "比较 Go 桌面 GUI 技术方案，并记录使用 qamel 连接 Go 后端与 QML 界面的实践。"
versionNote: "本文基于 2020 年的 qamel/Qt 生态，项目维护状态和构建方式可能已经变化。"
tags:
  - QML
  - Go
  - GUI
...
开发的项目是直播助手，相关介绍在 [B 站直播协议分析上]({{< relref "posts/B站直播助手开发[上].md" >}}) 有介绍，这里说一下技术选型方面遇到的问题，踩的坑，希望给后续的人一点建议和参考。
...
> 原错误截图所在的历史图床已经失效。错误现象是构建时提示找不到 `QApplication`；不影响下文结论。
