...
description: "通过简化的 Go RPC 框架，理解网络传输、服务注册与注册中心的基本结构。"
versionNote: "本文为未完成的教学实现，仅用于理解 RPC 基本结构，不建议直接用于生产。"
tags:
  - Go
  - RPC
  - 框架
...
> [你觉得 HTTP 哪都好用是因为你不知道 RPC]({{< relref "posts/rpc/rpcVShttp.md" >}})
...
![RPCg 客户端、注册中心与服务端关系图](https://blogimagee.oss-cn-beijing.aliyuncs.com/images/2C28140D4115AF68D708DAB4515B012C.jpg)
