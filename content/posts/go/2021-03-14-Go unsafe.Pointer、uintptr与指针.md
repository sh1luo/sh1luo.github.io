...
description: "解释 Go 指针、unsafe.Pointer 与 uintptr 的语义边界、转换规则和内存安全风险。"
versionNote: "本文基于 2021 年前后的 Go 规范与实现，unsafe 相关代码应始终以当前官方文档为准。"
tags:
  - Go
  - 源码
---
...
![普通指针、unsafe.Pointer 与 uintptr 的转换关系](https://blogimagee.oss-cn-beijing.aliyuncs.com/images/unsafe_uintptr_p.svg)
